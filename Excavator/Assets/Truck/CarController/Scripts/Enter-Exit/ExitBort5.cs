...
public class ExitBort5 : MonoBehaviour {
	...
	void Update (){
		...
		{
	kuzov.GetComponent<Animator>().enabled = true;
	cilindr.GetComponent<Animator>().enabled = true;
	
		}
	if(Input.GetKeyUp(KeyCode.F))
		{
	kuzov.GetComponent<Animator>().enabled = false;
	cilindr.GetComponent<Animator>().enabled = false;
